...
export class CalendarEventSidebarComponent implements OnInit {
  ...
  updateEvent() {
    ...
    this.event.startDate = this.startDatePicker.flatpickrElement.nativeElement.children[0].value;
    this.event.endDate = this.endDatePicker.flatpickrElement.nativeElement.children[0].value;
