...
@Component({
  selector: 'app-evaluation-info-table',
  templateUrl: './evaluation-info-table.component.html',
  styleUrls: ['./evaluation-info-table.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EvaluationInfoTableComponent implements OnInit {
...
/**
   ...
   * @param {EvaluationInfoServiceService} _IdentityService
   * @param {CoreSidebarService} _coreSidebarService
   */
  constructor(
    private _userListService: EvaluationInfoServiceService,
