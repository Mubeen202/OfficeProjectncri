...
export class EmailListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log('this is running', this.emailData)
    this._emailService.EmailListing.pipe(takeUntil(this._unsubscribeAll)).subscribe(AllMails => {
      console.log("🚀 ~ file: email-list.component.ts:109 ~ EmailListComponent ~ this._emailService.onSelectedEmailsChanged.pipe ~ selectedMails", AllMails)
      // setTimeout(() => {
