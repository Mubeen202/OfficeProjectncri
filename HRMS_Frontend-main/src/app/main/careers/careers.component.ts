...
export class CareersComponent implements OnInit {
  ...
  submitApplication() {
    ...
    if(this.name && this.email && this.linkedInUrl && this.socialUrl !== null){
      ...
      this.careersService.submitApplication(value).then((dataResponse: any) => {
  ...
  refreshCareerList() {
    this.careersService.careerJobs().then((data: any) => {
  ...
  uploadResume(event){
    ...
    this.careersService.uploadFile(formData).then((response:any)=>{
